...
setSelectedVariant(variant);
  ...
  return (
    <div className="flex flex-col gap-6">
            ...
            {option.choices?.map((choice) => {
              ...
              return option.name === "Color" ?
               (
                ...
                <li className=" ring-1 ring-naveed text-naveed rounded-md py-1 px-4 text-sm " style={{
                  cursor: disabled ? "not-allowed" : "pointer",
      ...
      <Add productId={productId} variantId={selectedVariant?._id || "00000-00000-00000-0000000 "} stockNumber={selectedVariant?.stock?.quantity || 0} />
      {/* color */}
      {/* // (
      //   <div
      //     className=""
      ...
      <ul className="flex items-center gap-3">
        <li className=" ring-1 ring-naveed text-naveed rounded-md py-1 px-4 text-sm cursor-pointer"> Small</li>
        <li className=" ring-1 ring-naveed text-white bg-naveed rounded-md py-1 px-4 text-sm cursor-pointer"> Medium</li>
